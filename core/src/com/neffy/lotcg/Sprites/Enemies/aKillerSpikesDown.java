...
public class aKillerSpikesDown extends Enemy{
    ...
    public aKillerSpikesDown(PlayScreen screen, float x, float y) {
        super(screen, x, y);
        stateTimer = 0;
        ...
        frames.add(new TextureRegion(screen.getAtlas().findRegion("LotCGSprite"), 320, 0, 16, 16));

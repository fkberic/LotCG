...
public class SpikePlatformLeft extends Sprite{
    ...
    public SpikePlatformLeft(PlayScreen screen, float x, float y) {
        ...
        platformIdle = new TextureRegion(getTexture(), 337, 0, 16, 16);
